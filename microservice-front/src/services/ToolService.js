...
const apiBase = import.meta.env.VITE_API_BASE_URL + "/inventory/api/tool";
...
export const rankingTools = () => axios.get(import.meta.env.VITE_API_BASE_URL + "/report/api/report/ranking");